...
"Chupame la pija",
"Bug del server (te crearon por error",
"Los gays son una mierda",
"Maten a curiosity gay"
],
    refranes: [
...
function obtenerRefranAleatorio() {
    return obtenerMensajeAleatorio('refranes');
}

function obtenerInsulto() {
    return obtenerMensajeAleatorio('insultos');
}
